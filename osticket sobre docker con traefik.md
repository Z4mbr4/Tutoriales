...
slug: 'Osticket_sobre_docker_con_traefik'
title: 'Osticket sobre docker con traefik
---

# Osticket sobre docker con traefik

En el siguiente docker-compose se encuentra detallado la instalación de Osticket con traefik mas no asi la instalación propia de traefik que deberan tener funcionando. Recuerden tambien las redes publicadas tienen que tener concordancia.
